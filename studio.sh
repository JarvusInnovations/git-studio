...
test -z "$(git status --porcelain --ignore-submodules)" || _error_exit "You have uncommited changes, commit or clear any changes and start the studio in a clean working tree"
